...
external interface IDBDatabase : JsAny {
     ...
     *
     * @return the created object store as [com.tecknobit.kassaforte.wrappers.indexeddb.IDBObjectStore]
     */
     ...
     *
     * @return the created transaction as [com.tecknobit.kassaforte.wrappers.indexeddb.IDBTransaction]
     */
    fun transaction(
        storeNames: String,
        mode: String,
